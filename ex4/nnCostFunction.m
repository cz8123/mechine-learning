...
% 正向传播法计算 h  Theta1:25x401   Theta2:10x26
...
delta3 = h - Y; % 10x5000
delta2 = Theta2(:,2:end)'*delta3.*sigmoidGradient(z2); % 25x5000
...
Theta1_grad = (1/m)*(Delta1 + lambda*Theta1); % 25x401
Theta2_grad = (1/m)*(Delta2 + lambda*Theta2); % 10x26
